...
(deftest filter-dataset-test
  ...
  (is (empty? (board-report/filter-dataset
               ...
               [{"Level" "England", "Denominator" "883852.0", "Breakdown" "England",
                 ...
                 "Period of coverage" "July 2013 to March 2014", "Numerator" "757456.1"}
                {"Level" "England", "Denominator" "948507.5", "Breakdown" "England",
                 "Question response rate" "97.7", "_id" 2, "indicator_id" nil,
                 "Year" "2012/13", "Level description" "England", "Indicator value" "86.7",
                 "Period of coverage" "July 2012 to March 2013", "Numerator" "822728.3"}
                {"Level" "Wales", "Denominator" "1009576.2", "Breakdown" "England",
                 "Question response rate" "97.3", "_id" 3, "indicator_id" nil,
                 "Year" "2011/12", "Level description" "England", "Indicator value" "88.3",
                 "Period of coverage" "July 2011 to March 2012", "Numerator" "891213.9"}])))
...
(deftest enrich-dataset-test
  ...
  (is (=[{"Level" "England", "Denominator" "883852.0", "Indicator id" "22",
          ...
          "indicator_id" nil, "Year" "2013/14", "Level description" "England",
          "Period of coverage" "July 2013 to March 2014", "Numerator" "757456.1"}
         {"Level" "England", "Denominator" "948507.5", "Indicator id" "22",
          "Breakdown" "England", "Value" "86.7", "Question response rate" "97.7", "_id" 2,
          "indicator_id" nil, "Year" "2012/13", "Level description" "England",
          "Period of coverage" "July 2012 to March 2013", "Numerator" "822728.3"}
         {"Level" "Wales", "Denominator" "1009576.2", "Indicator id" "22",
          "Breakdown" "England", "Value" "88.3", "Question response rate" "97.3",
          "_id" 3, "indicator_id" nil, "Year" "2011/12", "Level description" "England",
          "Period of coverage" "July 2011 to March 2012", "Numerator" "891213.9"}]
        ...
        (board-report/enrich-dataset
         ...
         (board-report/filter-dataset
          ...
          [{"Level" "England", "Denominator" "883852.0",
            "Breakdown" "England", "Question response rate" "97.9",
            "_id" 1, "indicator_id" nil, "Year" "2013/14",
            "Level description" "England", "Indicator value" "85.7",
            "Period of coverage" "July 2013 to March 2014", "Numerator" "757456.1"}
           {"Level" "England", "Denominator" "948507.5", "Breakdown" "England",
            "Question response rate" "97.7", "_id" 2, "indicator_id" nil,
            "Year" "2012/13", "Level description" "England", "Indicator value" "86.7",
